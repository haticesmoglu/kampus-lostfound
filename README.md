...
*  **Yetkili (Security/Admin) Yönetim Paneli:** Yeni ilanlar için "Pending" mekanizması, ilan onaylama/reddetme ve yayındaki tüm aktif ilanları sistemden kaldırma yetkisi.
